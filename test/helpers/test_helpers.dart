...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<RemoteServices>(onMissingStub: OnMissingStub.returnDefault)
  // @stacked-mock-spec
])
...
MockRemoteServices getAndRegisterRemoteService() {
  _removeRegistrationIfExists<RemoteServices>();
  final service = MockRemoteServices();
  locator.registerSingleton<RemoteServices>(service);
  return service;
}
